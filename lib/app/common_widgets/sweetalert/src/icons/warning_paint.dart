...
class WarningPaint extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Path path = Path();
    path.moveTo(
      size.width * 0.4376250,
      size.height * 0.6875000,
    );

    path.arcToPoint(
      Offset(
        size.width * 0.5626250,
        size.height * 0.6875000,
      ),
    ...
    path.arcToPoint(
      Offset(size.width * 0.4376250, size.height * 0.6875000),
      radius: Radius.elliptical(
        size.width * 0.06250000,
        size.height * 0.06250000,
      ),
    ...
    path.arcToPoint(
      ...
      radius: Radius.elliptical(
        size.width * 0.05656250,
        size.height * 0.05656250,
      ),
      rotation: 0,
      largeArc: true,
      clockwise: true,
    ...
    path.arcToPoint(
      ...
      radius: Radius.elliptical(
        size.width * 0.03456250,
        size.height * 0.03456250,
      ),
      rotation: 0,
      largeArc: false,
      clockwise: true,
